...
sudo rm "/Library/LaunchAgents/de.miralem-cebic.launchagent.plist"
fi
...
sudo rm "/Library/LaunchDaemons/de.miralem-cebic.launchdaemon.plist"
fi


sudo killall LaunchAgent-Daemon
sudo killall LaunchDaemon-Daemon
